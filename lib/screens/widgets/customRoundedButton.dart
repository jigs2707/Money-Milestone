        ...
        child: Platform.isIOS
                ...
                child: Container(
                  decoration: BoxDecoration(
                    gradient: backgroundColor != null
                        ? null
                        : Utils.gradiant(context),
                    color: backgroundColor,
                    borderRadius:
                        borderRadius ?? BorderRadius.circular(radius ?? 24),
                    border: showBorder
                        ? Border.all(
                            color: borderColor ?? context.colors.accentColor,
                            width: 1.5)
                        : null,
                  ),
            ...
            : MaterialButton(
                ...
                shape: RoundedRectangleBorder(
                  side: BorderSide(
                    color: showBorder
                        ? borderColor ?? context.colors.accentColor
                        : Colors.transparent,
                  ),
                  borderRadius:borderRadius ?? BorderRadius.all(Radius.circular(radius ?? 24)),
                ),
                ...
                child: Container(
                  decoration: BoxDecoration(
                    gradient: backgroundColor != null? null :Utils.gradiant(context),
                  ...
                  child: Center(
                    child: child ??
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: textSize ?? 18.0,
                            color: titleColor ?? context.colors.blackColors,
